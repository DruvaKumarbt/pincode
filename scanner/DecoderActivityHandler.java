...
public final class DecoderActivityHandler extends Handler {
	private static final String TAG = DecoderActivityHandler.class
			.getSimpleName();
	...
	DecoderActivityHandler(IDecoderActivity activity,
	...
	public void handleMessage(Message message) {
		...
		case R.id.return_scan_result:
			...
			if (activity instanceof Activity) {
				((Activity) activity).setResult(Activity.RESULT_OK,
						(Intent) message.obj);
				((Activity) activity).finish();
			} else {
				Log.e(TAG,
						"Scan result message, activity is not Activity. Doing nothing.");
			}
			break;
		}
	}
